    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserTeam", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationUserTeam_AspNetUsers_ApplicationUserId1",
                        column: x => x.ApplicationUserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ApplicationUserTeam_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TeamId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LearningBadgeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamLearningBadge_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserTeamScenario",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ApplicationUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ApplicationUserTeamId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ScenarioId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserTeamScenario", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationUserTeamScenario_ApplicationUserTeam_ApplicationUserTeamId",
                        column: x => x.ApplicationUserTeamId,
                        principalTable: "ApplicationUserTeam",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ApplicationUserTeamScenario_Scenarios_ScenarioId",
                        column: x => x.ScenarioId,
                        principalTable: "Scenarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserTeamScenario_ApplicationUserTeamId",
                table: "ApplicationUserTeamScenario",
                column: "ApplicationUserTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserTeamScenario_ScenarioId",
                table: "ApplicationUserTeamScenario",
                column: "ScenarioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamLearningBadge_TeamId",
                table: "TeamLearningBadge",
                column: "TeamId");
        }
